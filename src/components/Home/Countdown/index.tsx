        ...
        <div className="relative overflow-hidden z-1 rounded-lg bg-[#D0E9F3] p-4 sm:p-7.5 lg:p-10 xl:p-15">
          <div className="max-w-[422px] w-full">
            ...
            <h2 className="font-bold text-dark text-xl lg:text-heading-4 xl:text-heading-3 mb-3">
              Lancez votre site avant la fin de l’année
            </h2>

            <p>Profitez de nos tarifs de lancement sur tous nos services de développement et d’hébergement.</p>
          ...
          <Image
            ...
            alt="product"
            className="hidden lg:block absolute right-4 xl:right-33 bottom-16 xl:bottom-24 -z-1"
            width={411}
            height={376}
          />
        </div>
